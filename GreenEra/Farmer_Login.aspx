<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Farmer_Login.aspx.cs" Inherits="GreenEra.Farmer_Login" %>
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary">Sign in Farmer Account</h3>
                            </a>
                        </div>
                       <div class="form-floating mb-3">
                        ...
                        <asp:Button class="btn btn-primary py-3 w-100 mb-4" Text="Sign In" runat="server" OnClick="farmer_login" />
                        <%--<button type="submit" class="btn btn-primary py-3 w-100 mb-4">Sign In</button>--%>
                        <p class="text-center mb-0">Don't have an Account? <a href="Farmer_Register.aspx">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>
