<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Farmer_Register.aspx.cs" Inherits="GreenEra.Farmer_Register" %>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                                <h3 class="text-primary">Create Farmer Account</h3>
                        </div>
                        ...
                        <asp:Button class="btn btn-primary py-3 w-100 mb-4" Text="Sign Up" runat="server" OnClick="farmer_register" />
                        <%--<button type="submit" class="btn btn-primary py-3 w-100 mb-4" OnClick="Admin_signup">Sign Up</button>--%>
                        <p class="text-center mb-0">Already have an Account? <a href="Farmer_Login.aspx">Sign In</a></p>
                    </div>
                </div>
            </div>
        </div>
